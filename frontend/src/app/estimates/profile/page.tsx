...
function ProfileContent() {
  ...
  useEffect(() => {
    ...
    async function fetchData() {
      try {
        const docRef = doc(db, 'estimates', id as string);
  ...
  return (
    <div className="min-h-screen lg:pl-64 bg-gray-50 font-sans pb-20 md:pb-0">
      <SideNav title="Estimate Details" />
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-8 max-w-4xl mx-auto min-h-[800px]">
          <div className="flex justify-between items-start border-b border-slate-200 pb-8 mb-8">
            <div>
              <h2 className="text-3xl font-light text-slate-800 uppercase tracking-wider mb-2">Estimate</h2>
