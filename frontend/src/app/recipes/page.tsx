    ...
    <div className="min-h-screen bg-gray-100 font-sans">
      ...
      <main className="max-w-7xl mx-auto py-12 sm:px-6 lg:px-8">
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden p-12 text-center">
          <div className="mx-auto flex h-24 w-24 items-center justify-center rounded-full bg-pink-100 mb-6">
            <span className="text-4xl">🍰</span>
          </div>
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Recipe Costing Engine</h2>
          <p className="text-gray-500 max-w-lg mx-auto">
            This module is currently under construction. Soon you'll be able to build dynamic recipes, calculate per-slice costs, and track ingredient yield percentages.
          </p>
          <div className="mt-8">
